package com.zy.open.lib.adapter.list;
...
public abstract class ListAdapter<T> extends BaseAdapter {
	...
	public ListAdapter(Context context, List<T> data, Map<Integer, Integer> layouts) {
		this.mData = data;
		this.mContext = context;
	...
	protected  <T extends View> T getChildView(View view, int id) {
		return ListViewHolder.get(view, id);
	}
